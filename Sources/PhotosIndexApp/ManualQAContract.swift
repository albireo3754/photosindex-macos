...
enum ManualQAElement: String, CaseIterable {
    ...
    case assetPreview = "photosindex.asset-preview"
    case mediaViewer = "photosindex.media-viewer"
    case mediaClose = "photosindex.media-close"
    case mediaRetry = "photosindex.media-retry"
    case mediaPlayer = "photosindex.media-player"
